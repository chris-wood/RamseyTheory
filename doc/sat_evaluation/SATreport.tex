...
\begin{table}
	...
	\begin{tabular}{c | c | c | c | c | c}
		\hline
		$n$ & $m_s$ & $m_r$ & $r$ & Variables (min, avg, max) & Clauses (min, avg, max) & Ratio (min, avg, max) \\ \hline
		~ & NA & NA & NA & NA & NA & NA \\
		\hline
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{c | c | c | c | c | c}
		\hline
		$m$ & $s$ & $m_s$ & $m_r$ & $r$ & Variables (min, avg, max) & Clauses (min, avg, max) & Ratio (min, avg, max) \\ \hline
		~ & ~ & 0 & NA & NA & NA & NA & NA \\ 
		\hline
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{c | c | c | c | c | c}
		\hline
		$n$ & $p$ & $m_s$ & $m_r$ & $r$ & Variables (min, avg, max) & Clauses (min, avg, max) & Ratio (min, avg, max) \\ \hline
		~ & ~ & NA & NA & NA & NA & NA & NA \\
		\hline
	\end{tabular}
