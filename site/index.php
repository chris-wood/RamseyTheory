        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <ul class="nav">
                    ...
                    <li><a href="<?php echo $dir_info;?>log">Research Log</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="hero-unit" style="vertical-align: middle;">
                <div class="row-fluid">
                    <div class="span6">
                        <h2>Welcome!</h2>
                        <p>
                            We're a group of professors, researchers, and students using computational techniques to tackle mathematical problems
                            related to the study of Folkman numbers, a topic closely related to Ramsey theory and Ramsey numbers.
                            ...
                            to find exact values of Folkman numbers, where possible, and narrowing the known bounds 
                            in the process.
                        </p>
                    </div>
                    <div class="span5">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="span10 offset 1">
                        <p>
                        Folkman numbers, first introduced by Folkman in 1970, are concerned
